...
@JsonSubTypes({
    @Type(value = ODataConnectorRequest.HttpMethod.Get.class, name = "get"),
    @Type(value = ODataConnectorRequest.HttpMethod.Post.class, name = "post"),
    @Type(value = ODataConnectorRequest.HttpMethod.Put.class, name = "put"),
    @Type(value = ODataConnectorRequest.HttpMethod.Patch.class, name = "patch"),
    @Type(value = ODataConnectorRequest.HttpMethod.Delete.class, name = "delete")
})
